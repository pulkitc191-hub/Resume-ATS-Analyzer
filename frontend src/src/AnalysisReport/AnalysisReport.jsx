        ...
        <div className={Styles.page}>
            ...
            <nav className={Styles.nav}>
                ...
                <div className={Styles.navActions}>
                    <button className={Styles.btnGhost} onClick={() => navigate("/upload")}>Analyse Another</button>
            ...
            <main className={Styles.mainContent}>
                ...
                {isError && (
                    <div className={Styles.errorCard}>
                        ...
                        <button className={Styles.btnPrimary} onClick={() => navigate("/upload")}>Try Again</button>
                    </div>
                )}
            </main>
